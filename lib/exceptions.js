...
const Exceptions = {
    ...
    DATA_IS_NOT_OBJECT: {
        message: `${prefix}When "getters" are not defined, "data" parameter of render function must be an Object` +
                 ` only (a non-empty "old-school" JS Object or a non-empty Map) but not any primitive JS type and` +
                 ` can't be undefined`,
...
const ErrorName = {
    ...
    PH_BLANK_BETWEEN_NESTED_LEXEMES: 'There is no delimiter (dot, comma, square bracket, etc.) between two '
