...
const Exceptions = {
    ...
    UNTERMINATED_ESC_TAIL: {
        message: `An incomplete escape sequence was found. After "\\u" there should be four hexadecimal digits, ` +
                 `after "\\x" - two hexadecimal digits. `,
        name:    'Unterminated ESC sequence',
        code:    30
    },
    ...
    UNEXPECTED_ESCAPING: {
        message: `Forbidden syntax construct: An escape character was found outside the string literal. `,
        name:    'Unexpected escaping',
        code:    36
    },
