        ...
        if (BLANKS.includes(symbol)) {
            switch (status) {
                ...
                case STATUS.ESC_TAIL:
                    Throw(Exceptions.INVALID_ESC_TAIL, eFormatter(layerName, fullEntry, symbol, position));
                    break;
            }
            ...
            switch (status) {
                ...
                case STATUS.ESC_TAIL:
                    if (/[a-fA-F0-9]/.test(symbol)) {
                        ...
                        Throw(Exceptions.UNTERMINATED_ESC_TAIL, eFormatter(layerName, fullEntry, symbol, position));
                    }
                    break;
            }
        }
